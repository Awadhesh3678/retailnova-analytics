-- ============================================================
-- RETAIL SALES DATABASE - DIRECT PRODUCTION SCHEMA
-- Execute this file from top to bottom.
-- ============================================================
...
-- 11. ORDER STATUS
-- Dependency: none
-- 1. Turn off foreign key safety checks
SET FOREIGN_KEY_CHECKS = 0;

-- 2. Clear the table and reset auto-increment counters
TRUNCATE TABLE `retail_sales`.`order_status`;

-- 3. Turn foreign key safety checks back on immediately
